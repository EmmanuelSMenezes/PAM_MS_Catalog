...
MicroserviÃ§o responsÃ¡vel pelo **catÃ¡logo de serviÃ§os e produtos**. Gerencia categorias, produtos, preÃ§os dinÃ¢micos, disponibilidade, informaÃ§Ãµes tÃ©cnicas, imagens, variaÃ§Ãµes, combos e sistema de recomendaÃ§Ãµes dos serviÃ§os oferecidos.

### ðŸŽ¯ Principais Funcionalidades

- ðŸ“¦ **Produtos/ServiÃ§os**: CRUD completo do catÃ¡logo
- ðŸ·ï¸ **Categorias**: OrganizaÃ§Ã£o hierÃ¡rquica
- ðŸ’² **PreÃ§os**: GestÃ£o dinÃ¢mica de preÃ§os
- ðŸ“¸ **MÃ­dias**: Upload e gestÃ£o de imagens/vÃ­deos
- ðŸ”§ **EspecificaÃ§Ãµes**: Detalhes tÃ©cnicos
- ðŸ“Š **Estoque**: Controle de disponibilidade
- ðŸŽ **Combos**: Pacotes e ofertas especiais
- ðŸ¤– **RecomendaÃ§Ãµes**: Sistema de sugestÃµes IA
...
`ash
# Build da imagem
docker build -t PAM_MS_Catalog.ToLower() .
...
- **ProduÃ§Ã£o**: https://api.pam.com/PAM_MS_Catalog.ToLower()/swagger
...
curl -X GET "http://localhost:5004/api/v1/..." \
...
az webapp deploy --resource-group PAM --name PAM_MS_Catalog --src-path ./publish
`
...
`ash
# Tag da imagem
docker tag PAM_MS_Catalog.ToLower() registry.azurecr.io/pam/PAM_MS_Catalog.ToLower():latest

# Push para registry
docker push registry.azurecr.io/pam/PAM_MS_Catalog.ToLower():latest
`
...
- **ðŸ› Issues**: [GitHub Issues](https://github.com/EmmanuelSMenezes/PAM_MS_Catalog/issues)
- **ðŸ“– Wiki**: [DocumentaÃ§Ã£o Completa](https://github.com/EmmanuelSMenezes/PAM_MS_Catalog/wiki)
...
**[â¬† Voltar ao Topo](#-PAM_MS_Catalog)**
