...
MicroserviÃ§o responsÃ¡vel pelo catÃ¡logo de serviÃ§os e produtos. Gerencia categorias, produtos, preÃ§os, disponibilidade e informaÃ§Ãµes tÃ©cnicas dos serviÃ§os oferecidos.
...
2. **Execute o container**
   `ash
   docker run -p 5004:5004 -e ConnectionStrings__DefaultConnection="sua-connection-string" PAM_MS_Catalog.ToLower()
   `

## ðŸ“š DocumentaÃ§Ã£o da API

A documentaÃ§Ã£o completa da API estÃ¡ disponÃ­vel via Swagger UI:
- **Desenvolvimento**: http://localhost:5004/swagger
